    ...
    for idx_mdot, md in enumerate(mdot):
        ...
        for idx_v, vin in enumerate(vinfall):
            ...
            for idx_incl, inc in enumerate(incl):
                ...
                ax.plot([0, 0], [-20, 20], 'w:')
                ax.plot([-30, 30], [0, 0], 'w:')
                plt.savefig(f'./Figures/pv/amax_mdot/scattering/incl_{inc}_vinfall_{vin:.1f}_amax_{a}_mdot_{idx_mdot+5}.png')
                plt.close()
                ...
                ax.plot([0, 0], [-20, 20], 'w:')
                ax.plot([-30, 30], [0, 0], 'w:')
                plt.savefig(f'./Figures/pv/amax_mdot/noline/incl_{inc}_vinfall_{vin:.1f}_amax_{a}_mdot_{idx_mdot+5}.png')
                plt.close()
                ...
                ax.plot([0, 0], [-20, 20], 'w:')
                ax.plot([-30, 30], [0, 0], 'w:')
                plt.savefig(f'./Figures/pv/amax_mdot/extracted_gas/incl_{inc}_vinfall_{vin:.1f}_amax_{a}_mdot_{idx_mdot+5}.png')
                plt.close()
