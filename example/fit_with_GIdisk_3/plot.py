...
print(theta_max)
a, mstar, mdot = theta_max[0], theta_max[1], theta_max[2] -0.1
# a, mstar, mdot = -1.1, 0.15, np.log10(4e-7)
...
ax[1].set_yticks([])
ax[1].set_title('Best-fit GIdisk model (fitted by emcee)', fontsize=14)
