...
# Define contour levels (10σ, 20σ, 40σ, ..., 640σ)
...
# Add beam ellipse
beam = Ellipse((105, 15), width=beam_minor_pixels, height=beam_major_pixels,
               angle=beam_pa, edgecolor='black', facecolor='black', lw=1.5, fill=True)
ax.add_patch(beam)

plt.plot([30-100/au_per_pix, 30+100/au_per_pix],[10, 10], "k", lw=3)
plt.text(30, 15, '200 AU', color='k', ha='center', va='top')
